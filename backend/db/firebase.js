...
export async function getRunsForToken(mint, limit = 50) {
  return queryDocs('runs', [['tokenMint', '==', mint]], 'timestamp', limit);
}

export async function getAllRuns(limit = 100) {
  return queryDocs('runs', [], 'timestamp', limit);
}
...
export async function getBuybacksForToken(mint, limit = 50) {
  return queryDocs('buybacks', [['tokenMint', '==', mint]], 'timestamp', limit);
}

export async function getAllBuybacks(limit = 100) {
  return queryDocs('buybacks', [], 'timestamp', limit);
}
